...
public class MouseMovementAction : Action
{
    ...
    {
        entity.body.velocity = Vector3.ProjectOnPlane(transform.forward*speed*charge,Vector3.up);
        while(entity.grounded == true && entity.body.velocity.magnitude>0.1f)
        {
            ...
            transform.forward = Vector3.ProjectOnPlane(entity.body.velocity,transform.up);
